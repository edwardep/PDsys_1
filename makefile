...
clean:
	rm hamm_seq hamm_omp_a hamm_omp_b hamm_omp_c hamm_pt_a hamm_pt_b hamm_pt_c
	rm hamming.o hamm_omp_a.o hamm_omp_b.o hamm_omp_c.o hamm_pt_a.o hamm_pt_b.o hamm_pt_c.o